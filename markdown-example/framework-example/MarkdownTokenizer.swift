...
/// Breaks a string into Markdown tokens.
///
/// How to use it:
///
///        var tokenizer = MarkdownTokenizer(string: "_Hello *world*_")
...
struct MarkdownTokenizer {
    ...
    private mutating func scanLeft(delimiter: UnicodeScalar) -> MarkdownToken? {
    ...
    private mutating func scanRight(delimiter: UnicodeScalar) -> MarkdownToken? {
